$(function () {
  ...
  var seekT,
    ...
    bTime,
    nTime = 0
  var musicImgsData = ['img/bg4.jpg', 'img/bg4.jpg', 'img/bg4.jpg'] // 图片地址数组
  var musicNameData = ['东京不太热', '霜雪千年', '夜宴风波'] // 歌曲名数组
  var artistNameData = ['洛天依', '洛天依', '洛天依'] // 创作歌手数组
  var musicUrls = ['mp3/music4.mp3', 'mp3/music5.mp3', 'mp3/music.mp3'] // 歌曲mp3数组
  ...
  function showHover(event) {
    ...
    else insTime.text(ctMinutes + ':' + ctSeconds) // 设置鼠标移动到进度条上显示的信息
  ...
  function updateCurrTime() {
    ...
    if (isNaN(durMinutes) || isNaN(durSeconds)) totalTime.text('00:00')
    else totalTime.text(durMinutes + ':' + durSeconds)
